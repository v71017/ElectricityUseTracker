package com.track.electricity.consumption.aspect;
 ...
 * @author VIDYA
 * 
 * Is a logging aspect for logging the entrance and exits of methods in Electricity consumption application
 */
@Slf4j
@Aspect
@Component
public class LoggingPointcutAspect {
     ...
     */
    @Pointcut("within(com.electricity.energy.consumption.controller..*)")
     ...
     */
    @Pointcut("within(com.electricity.energy.consumption.annotation.valid..*)")
     ...
     */
    @Pointcut("within(com.electricity.energy.consumption.cache.service..*)")
